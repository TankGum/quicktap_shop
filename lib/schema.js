...
export const localBusinessSchema = {
  ...
  //
  // TODO: điền `priceRange` (ví dụ '99.000₫ - 250.000₫') khi chốt được khoảng giá. Cố ý để
  // trống thay vì bịa — Google phạt dữ liệu có cấu trúc sai lệch nặng hơn nhiều so với việc
  // thiếu một trường không bắt buộc.
};
