...
export const siteConfig = {
  ...
  //
  // Chỉ nêu đúng phần đã chốt: Hà Nội miễn phí, không có mức đơn tối thiểu. Tỉnh khác CỐ Ý
  // không nêu con số — điều khoản sử dụng đang nói phí giao báo lúc xác nhận đơn, giữ đúng vậy.
  shippingFreeRegion: 'Hà Nội',
  shippingPolicy:
    'Miễn phí giao hàng tại Hà Nội, kể cả khi chỉ đặt 1 cái — không có mức đơn tối thiểu. Các tỉnh thành khác giao toàn quốc, phí giao báo cụ thể khi xác nhận đơn.',
